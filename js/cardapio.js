...
function getInputValue(){
    ...
    <div class="modal-body 1">
    <h4>   </h4>
     <a class="linkWhats" href="https://wa.me/554991665420?text=Endeço:%20${end}%20Número da residência:%20${numero}%20 Total:${total}%20Pedido:%20${Array}">Envie seu pedido!</a>
    </div>
